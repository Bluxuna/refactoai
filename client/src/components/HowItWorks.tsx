    ...
    <section className="py-20">
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-7xl mx-auto">
          {/* Single row flow */}
          <div className="grid grid-cols-1 md:grid-cols-[1fr_auto_1fr_auto_1fr] gap-4 items-center max-w-6xl mx-auto">
            {/* Step 1: Messy Code */}
            ...
            {/* Step 2: You Refactor */}
            <Card className="p-6 border-2 border-warning/50 bg-warning/5">
              <div className="flex flex-col items-center text-center space-y-4">
